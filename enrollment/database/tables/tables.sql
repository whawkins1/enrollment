...
-- Table enrolled_2017
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS enrolled_2017 (
  user_email_2017 VARCHAR(30) NOT NULL,
  user_grade_2017 CHAR(1) NOT NULL DEFAULT '-',
  user_semester_2017 CHAR(6) NOT NULL,
  user_course_code VARCHAR(10) NOT NULL,
  PRIMARY KEY (user_email_2017, user_semester_2017, user_course_code),
  FOREIGN KEY (user_email_2017)
      REFERENCES users(user_email),
  FOREIGN KEY(user_course_code)
      REFERENCES courses(code)
) ENGINE=InnoDB;
